package yicheng.android.ui.materialdesignlibrary.views;
	...
	public ProgressBarIndeterminateDeterminate(Context context,
		...
		post(new Runnable() {
			...
			public void run() {
				...
				setProgress(60);
				ViewHelper.setX(progressView, -progressView.getWidth());
				animation = ObjectAnimator.ofFloat(progressView, "x",
						getWidth());
				...
				animation.addListener(new AnimatorListener() {
					...
					public void onAnimationEnd(Animator arg0) {
						// Repeat animation
						if (runAnimation) {
							ViewHelper.setX(progressView,
									-progressView.getWidth());
							// cont += suma;
							animation = ObjectAnimator.ofFloat(progressView,
									"x", getWidth());
