...
public class ColorSelector extends android.app.Dialog implements
	...
	public ColorSelector(Context context, Integer color,
			OnColorSelectedListener onColorSelectedListener) {
		...
		setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) {
				if (ColorSelector.this.onColorSelectedListener != null)
					ColorSelector.this.onColorSelectedListener
							.onColorSelected(ColorSelector.this.color);
			}
		});
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		colorView.post(new Runnable() {
			...
			@Override
			public void run() {
				LinearLayout.LayoutParams params = (LayoutParams) colorView
						.getLayoutParams();
